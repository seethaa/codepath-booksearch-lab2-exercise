...
public class BookDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String thumbnail = book.getCoverUrl();

        //check if thumbnail is empty
        if (!TextUtils.isEmpty(thumbnail)){

            Picasso.with(this).load(thumbnail).into(ivBookCover, new Callback() {
                @Override
            ...
            Picasso.with(getApplicationContext()).load(thumbnail).into(ivBookCover);
